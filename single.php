            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <header class="entry-header">
                    ...
                    <div class="entry-meta">
                        <?php ispirit_entry_meta_single(); ?>
                        <span class="vcard author">
                            <?php echo sprintf(__('By <a href="%2$s" itemprop="author" class="fn">%1$s</a>'), $post_author, get_author_posts_url(get_the_author_meta( 'ID' ))); ?>
                        </span>                        
					...
					<div class="author-info-wrap clearfix">
						...
						<div class="author-bio">
							<div class="author-name" itemprop="author">
                            	<h3><?php _e("About", "ispirit"); ?> <span itemprop="name"><?php the_author_meta('display_name'); ?></span></h3>
                            </div>
							<div class="author-bio-text">
								<?php the_author_meta('description'); ?>
							</div>
                            <div class="author-more">
                                <a class="author-link colored" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
                                    <?php printf( __( 'View all posts by %s', 'ispirit' ), get_the_author() ); ?>
                                </a>                            
                            </div>
						</div>
					</div>
			...
			<?php if ($show_related == '1') { ?>
				...
				<?php
					...
					if( $related_posts_query->have_posts() ) {	
						echo '<h3 class="spb-heading"><span>'.__("Related Articles", "ispirit").'</span></h3>';
