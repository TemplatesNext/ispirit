<?php 
/**
 * Template for post carusel posts
 *
            ...
            <div class="nx-entry-thumbnail <?php echo $thumb_class; ?>">
                <?php
                    ...
                    else if ($post_thumb_type == 3)
                    {
                        ...
                        $thumb_resized = aq_resize( $post_thumb_slider_img, $th_width, $th_height, true ); //resize & crop the image
                        echo "<img src=\"".$thumb_resized."\" alt=\"\">";
                        $thumb_full_url = $post_thumb_slider_img;						
