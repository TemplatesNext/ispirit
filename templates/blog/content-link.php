            ...
            <div class="nx-footer-entry-meta nx-clearfix">
                <div class="nx-entry-meta-inner nx-clearfix">
                    ...
                    <?php
                        if( $atts['blog_layout'] == '1' )
                        {
                            $meta[] = sprintf( '<span class="nx-metawrap"><span class="nx-day"><span class="genericon genericon-link"></span></span></span>' );
                        } else
                        {
                            $meta[] = sprintf( '<span class="genericon genericon-link"></span>' );
                        }
