<?php 
/**
 * Template for portfolio gallery style
 *
	...
	<div class="nx-post-border">
        ...
        <div class="entry-thumbnail">
            	<?php
                    ...
                    {
						$post_thumbnail_img = reset($thumb_slider_images);
						echo "<img src=\"".aq_resize( $post_thumbnail_img['url'], $th_width, $th_height, true )."\" alt=\"\">";
						$thumb_full_url = $post_thumbnail_img['url'];
                    }
					/*	
