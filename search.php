...
get_header(); ?>
    ...
    <?php
		...
		{
			$blog_layout_type = "masonry";
			//$blog_template = "content-masonry";
		} else
		{
			$blog_layout_type = "standard";
			//$blog_template = "content-standard";
		}
        	...
        	<div class="titlebar <?php echo $header_text_class; ?>">
                <div class="heading-text">
                    <h1 class="entry-title">
						<?php printf( __( 'Search Results for: %s', 'ispirit' ), get_search_query() ); ?>                    
                    </h1>
                </div>
                <?php 
	...
	<div id="primary" class="content-area <?php echo $page_wrap_class; ?>">
		...
		<?php if ( have_posts() ) : ?>
            ...
            <div class="blogwrap sp-posts searchresults">
