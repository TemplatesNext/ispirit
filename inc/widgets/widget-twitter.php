...
class Twitter_Widget extends WP_Widget {
	...
	function __construct() {	
		...
		// Create the widget
		//$this->WP_Widget('twitter-widget', 'NX Tweets', $widget_ops);
		
		$widget_ops = array( 'classname' => 'twitter-widget', 'description' => 'Display your latest tweets.' );
        parent::__construct( 'twitter-widget', 'NX Tweets', $widget_ops );		
	}
	...
	function widget($args, $instance) {
		...
		$result .= nx_latest_tweet($tweets, $username);
...
?>
		<div class="widget-content">
            <p>
                <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'nx-admin'); ?></label>
                <input class="widefat" type="text" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>">
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('username'); ?>"><?php _e('Your Twitter username:', 'nx-admin'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('posts'); ?>"><?php _e('Display how many tweets?', 'nx-admin'); ?></label>
