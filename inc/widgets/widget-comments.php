	...
	*/	
	...
	class nx_recent_comments extends WP_Widget {
		...
		function __construct() {	
			//parent::WP_Widget( 'nx_recent_custom_comments', $name = 'NX Recent Comments', array( 'description' => __( 'NX Widget for Recent Comments', 'ispirit' ) ) );
			
			$widget_ops = array( 'classname' => 'nx_recent_custom_comments', 'description' => 'NX Widget for Recent Comments' );
        	parent::__construct( 'nx_recent_custom_comments', 'NX Recent Comments', $widget_ops );			
		}
								...
								<div class="comment-meta">
									<?php
										...
										printf('<span class="comment-author">%1$s</span> <span class="comment-date">%2$s</span>',
											...
											human_time_diff( $comment_date, current_time('timestamp') ) . ' ' . __("ago", "ispirit")
										);
									?>
								</div>
