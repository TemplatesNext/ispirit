	...
	*/		
	...
	class nx_advert_grid_widget extends WP_Widget {
		...
		function __construct() {	
			...
			$widget_ops = array( 'classname' => 'advert-grid-widget', 'description' => 'Styled advert grid of up to eight 125x125 adverts' );
        	parent::__construct( 'advert-grid-widget', 'NX Advert Grid Widget', $widget_ops );			
		}
