	...
	*/
	...
	class nx_recent_portfolio extends WP_Widget {
		...
		function __construct() {	
			//parent::WP_Widget( 'nx_recent_custom_portfolio', $name = 'NX Portfolio List', array( 'description' => __( 'NX Widget for Portofolio in list format', 'ispirit' ) ) );
			
			$widget_ops = array( 'classname' => 'nx_recent_custom_portfolio', 'description' => 'NX Widget for Portofolio in list format' );
        	parent::__construct( 'nx_recent_custom_portfolio', 'NX Portfolio List', $widget_ops );			
		}
