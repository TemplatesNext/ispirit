	...
	*/			
	...
	class nx_portfolio_grid extends WP_Widget {
		...
		function __construct() {	
			//parent::WP_Widget( 'nx_custom_portfolio_grid', $name = 'NX Portfolio Grid', array( 'description' => __( 'NX Widget for Portofolio in grid format', 'ispirit' ) ) );
			
			$widget_ops = array( 'classname' => 'nx_custom_portfolio_grid', 'description' => 'NX Widget for Portofolio in grid format' );
        	parent::__construct( 'nx_custom_portfolio_grid', 'NX Portfolio Grid', $widget_ops );			
		}
